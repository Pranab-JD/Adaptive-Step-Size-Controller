...
def ETD(A, u, dt, Leja_X, c_real_adv, Gamma_real_adv, c_imag_adv, Gamma_imag_adv):
    ...
    def Real_Leja():
        ...
        ### Solution
        u_lin, its = real_Leja_exp(A, u, 2, dt, Leja_X, c_real_adv, Gamma_real_adv)
        u_nl = real_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_real_adv, Gamma_real_adv) * dt
    ...
    def Imag_Leja():
        ...
        ### Solution
        u_lin, its = imag_Leja_exp(A, u, 2, dt, Leja_X, c_imag_adv, Gamma_imag_adv)
        u_nl = imag_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_imag_adv, Gamma_imag_adv) * dt
...
def ETDRK2(A, u, dt, Leja_X, c_real_adv, Gamma_real_adv, c_imag_adv, Gamma_imag_adv):
    ...
    def Real_Leja():
        ...
        ### ETD1 Solution
        u_lin_adv, mat_vec_num = real_Leja_exp(A, u, 2, dt, Leja_X, c_real_adv, Gamma_real_adv)
        u_nl_1 = real_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_real_adv, Gamma_real_adv) * dt
    ...
    def Imag_Leja():
        ...
        ### ETD1 Solution
        u_lin_adv, mat_vec_num = imag_Leja_exp(A, u, 2, dt, Leja_X, c_imag_adv, Gamma_imag_adv)
        u_nl_1 = imag_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_imag_adv, Gamma_imag_adv) * dt
        a_n = u_lin_adv + u_nl_1
...
def ETDRK4(A, u, dt, Leja_X, c_real_adv, Gamma_real_adv, c_imag_adv, Gamma_imag_adv):
    ...
    def Real_Leja():
        ...
        ### a_n ###
        u_lin_a, its_a = real_Leja_exp(A, u, 2, dt/2, Leja_X, c_real_adv, Gamma_real_adv)
        u_nl_a = real_Leja_phi(phi_1, Nonlin_u, dt/2, Leja_X, c_real_adv, Gamma_real_adv) * dt/2
        ...
        ### b_n ###
        u_lin_b = u_lin_a
        u_nl_b = real_Leja_phi(phi_1, Nonlin_a, dt/2, Leja_X, c_real_adv, Gamma_real_adv) * dt/2
        ...
        ### c_n ###
        u_lin_c, its_c = real_Leja_exp(A, a_n, 2, dt/2, Leja_X, c_real_adv, Gamma_real_adv)
        u_nl_c = real_Leja_phi(phi_1, (2*Nonlin_b - Nonlin_u), dt/2, Leja_X, c_real_adv, Gamma_real_adv) * dt/2
        ...
        u_lin_adv, its_lin = real_Leja_exp(A, u, 2, dt, Leja_X, c_real_adv, Gamma_real_adv)
        
        ### Nonlinear part of solution ###
        u_nl_1 = real_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_real_adv, Gamma_real_adv) * dt
        u_nl_2 = real_Leja_phi(phi_2, (-3*Nonlin_u + 2*(Nonlin_a + Nonlin_b) - Nonlin_c), dt, Leja_X, c_real_adv, Gamma_real_adv) * dt
        u_nl_3 = real_Leja_phi(phi_3, (4 * (Nonlin_u - Nonlin_a - Nonlin_b + Nonlin_c)), dt, Leja_X, c_real_adv, Gamma_real_adv) * dt
    ...
    def Imag_Leja():
        ...
        ### a_n ###
        u_lin_a, its_a = imag_Leja_exp(A, u, 2, dt/2, Leja_X, c_imag_adv, Gamma_imag_adv)
        u_nl_a = imag_Leja_phi(phi_1, Nonlin_u, dt/2, Leja_X, c_imag_adv, Gamma_imag_adv) * dt/2
        ...
        ### b_n ###
        u_lin_b = u_lin_a
        u_nl_b = imag_Leja_phi(phi_1, Nonlin_a, dt/2, Leja_X, c_imag_adv, Gamma_imag_adv) * dt/2
        ...
        ### c_n ###
        u_lin_c, its_c = imag_Leja_exp(A, a_n, 2, dt/2, Leja_X, c_imag_adv, Gamma_imag_adv)
        u_nl_c = imag_Leja_phi(phi_1, (2*Nonlin_b - Nonlin_u), dt/2, Leja_X, c_imag_adv, Gamma_imag_adv) * dt/2
        ...
        ### Linear part of solution ###
        u_lin_adv, its_lin = imag_Leja_exp(A, u, 2, dt, Leja_X, c_imag_adv, Gamma_imag_adv)
        
        ### Nonlinear part of solution ###
        u_nl_1 = imag_Leja_phi(phi_1, Nonlin_u, dt, Leja_X, c_imag_adv, Gamma_imag_adv) * dt
        u_nl_2 = imag_Leja_phi(phi_2, (-3*Nonlin_u + 2*(Nonlin_a + Nonlin_b) - Nonlin_c), dt, Leja_X, c_imag_adv, Gamma_imag_adv) * dt
        u_nl_3 = imag_Leja_phi(phi_3, (4 * (Nonlin_u - Nonlin_a - Nonlin_b + Nonlin_c)), dt, Leja_X, c_imag_adv, Gamma_imag_adv) * dt
