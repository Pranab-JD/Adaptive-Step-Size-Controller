...
def Richardson_Extrapolation_2(A_adv, m_adv, A_dif, m_dif, Method, p, u_sol, u, dt_inp, tol):
    """
    Parameters
    ----------
    p           		: Order of Method
...
def Trad_Controller(Method, p, u_sol_3, u_sol_4, u, dt_inp, tol):
    ...
    if error > tol:
        # print('xxxxxxxxxxxxxx Step size rejected xxxxxxxxxxxxxxxxxxxxxx', dt_inp)
        dt = dt_inp
